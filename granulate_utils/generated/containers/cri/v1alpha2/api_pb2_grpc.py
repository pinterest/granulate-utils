...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in v1alpha2/api_pb2_grpc.py depends on'
...
def add_RuntimeServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('runtime.v1alpha2.RuntimeService', rpc_method_handlers)
...
def add_ImageServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('runtime.v1alpha2.ImageService', rpc_method_handlers)
